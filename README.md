...
h2 { 
  font-family:spotify-circular, Helvetica, Arial, sans-serif;
  padding-right: 944.8819px;
  padding-bottom: none;
  padding-left: 944.8819px;
  padding-top: none;
...
<body onload="initializeApp()"> 
  ...
  <form action="connect.php" method="post" id="contactForm">

    <label for="fname">Email Adress</label>
    <input id="email" type="text" maxlength="100" placeholder="Type your email address here..." required class="london" name="email">

<label for="country" name="country" value="country">Country</label>
<select id="country" name="country">
   ...
   <option value="Zimbabwe">Zimbabwe</option>
    ...
    <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px" required class="scotland"></textarea>
    <label for="subject" name="subject" value="subjects">Subject</label>
